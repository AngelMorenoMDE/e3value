 ...
 * @generated
 */
public class E3valueInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new E3valueNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				E3ValueDiagramEditPart.MODEL_ID));
		E3valueDiagramEditorUtil.runWizard(getShell(), wizard,
