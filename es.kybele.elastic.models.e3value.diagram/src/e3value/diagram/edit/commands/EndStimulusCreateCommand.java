 ...
 * @generated
 */
public class EndStimulusCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public EndStimulusCreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		EndStimulus newElement = E3valueFactory.eINSTANCE.createEndStimulus();

		if (getElementToEdit() instanceof BusinessActor) {

			BusinessActor owner = (BusinessActor) getElementToEdit();
			owner.getHasDependenceElements().add(newElement);
	 ...
	 * @generated
	 */
	protected void doConfigure(EndStimulus newElement,
