 ...
 * @generated
 */
public class MarketSegmentNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public MarketSegmentNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = E3valueParserProvider
					.getParser(
							E3valueElementTypes.MarketSegment_3008,
							getParserElement(),
							E3valueVisualIDRegistry
									.getType(e3value.diagram.edit.parts.MarketSegmentNameEditPart.VISUAL_ID));
		}
		return parser;
	}
