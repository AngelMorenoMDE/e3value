...
import e3value.diagram.edit.policies.E3valueTextSelectionEditPolicy;
import e3value.diagram.part.E3valueVisualIDRegistry;
import e3value.diagram.providers.E3valueElementTypes;
import e3value.diagram.providers.E3valueParserProvider;

/**
 * @generated
 */
public class ElementaryActorNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ElementaryActorNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new E3valueTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = E3valueParserProvider
					.getParser(
							E3valueElementTypes.ElementaryActor_3009,
							getParserElement(),
							E3valueVisualIDRegistry
									.getType(e3value.diagram.edit.parts.ElementaryActorNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					E3valueEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
