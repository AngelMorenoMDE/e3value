 ...
 * @generated
 */
public class ValueActivityNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ValueActivityNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = E3valueParserProvider
					.getParser(
							E3valueElementTypes.ValueActivity_3005,
							getParserElement(),
							E3valueVisualIDRegistry
									.getType(e3value.diagram.edit.parts.ValueActivityNameEditPart.VISUAL_ID));
		}
		return parser;
	}
