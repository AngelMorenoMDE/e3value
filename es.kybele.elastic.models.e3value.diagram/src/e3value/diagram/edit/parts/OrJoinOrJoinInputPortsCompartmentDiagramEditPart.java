...
import e3value.diagram.edit.policies.OrJoinOrJoinInputPortsCompartmentDiagramCanonicalEditPolicy;
import e3value.diagram.edit.policies.OrJoinOrJoinInputPortsCompartmentDiagramItemSemanticEditPolicy;
 ...
 * @generated
 */
public class OrJoinOrJoinInputPortsCompartmentDiagramEditPart extends
	 ...
	 * @generated
	 */
	public OrJoinOrJoinInputPortsCompartmentDiagramEditPart(View view) {
		super(view);
	}
	...
	public String getCompartmentName() {
		return Messages.OrJoinOrJoinInputPortsCompartmentDiagramEditPart_title;
	}
	...
	public IFigure createFigure() {
		...
		ResizableCompartmentFigure result = (ResizableCompartmentFigure) super
				.createFigure();
		//result.addFigureListener(new OrJoinOrJoinOutputPortsCompartmentDiagramFigureListener(this));
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new OrJoinOrJoinInputPortsCompartmentDiagramItemSemanticEditPolicy());
		...
		installEditPolicy(
				...
				new OrJoinOrJoinInputPortsCompartmentDiagramCanonicalEditPolicy());
	}
