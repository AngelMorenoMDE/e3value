...
import e3value.diagram.edit.policies.InputPortItemSemanticEditPolicy;
...
public class InputPortEditPart extends ShapeNodeEditPart {
	...
	protected IFigure createNodeShape() {
		return primaryShape = new InputPortFigureDescriptor();
	}

	/**
	 * @generated
	 */
	public InputPortFigureDescriptor getPrimaryShape() {
		return (InputPortFigureDescriptor) primaryShape;
	}
	 ...
	 * @generated
	 */
	public class InputPortFigureDescriptor extends Ellipse {

		/**
		 * @generated
		 */
		public InputPortFigureDescriptor() {
