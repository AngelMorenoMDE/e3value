 ...
 * @generated
 */
public class CompositeActorNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public CompositeActorNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = E3valueParserProvider
					.getParser(
							E3valueElementTypes.CompositeActor_3016,
							getParserElement(),
							E3valueVisualIDRegistry
									.getType(e3value.diagram.edit.parts.CompositeActorNameEditPart.VISUAL_ID));
		}
		return parser;
	}
