...
public class ValuePortInFigureListener implements FigureListener {

	private ValuePortInEditPart _container = null;
	
	public ValuePortInFigureListener(ValuePortInEditPart valuePortInEditPart) {
		_container = valuePortInEditPart;
	}

	@Override
	public void figureMoved(IFigure source) {
		ValuePortInFigureDescriptor _vpifd = (ValuePortInFigureDescriptor) source.getChildren().get(0);
