 ...
 * @generated
 */
public class ValueObjectItemSemanticEditPolicy extends
	...
	public ValueObjectItemSemanticEditPolicy() {
		super(E3valueElementTypes.ValueObject_3023);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (E3valueVisualIDRegistry.getVisualID(incomingLink) == ValueExchangeHasValueObjectEditPart.VISUAL_ID) {
