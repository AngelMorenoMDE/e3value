 ...
 * @generated
 */
public class ValueInterfaceItemSemanticEditPolicy extends
		E3valueBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public ValueInterfaceItemSemanticEditPolicy() {
					...
					case ValuePortOutEditPart.VISUAL_ID:
						for (Iterator<?> it = cnode.getTargetEdges().iterator(); it
							...
							if (E3valueVisualIDRegistry
									.getVisualID(incomingLink) == ValueExchangeEditPart.VISUAL_ID) {
						...
						for (Iterator<?> it = cnode.getSourceEdges().iterator(); it
							...
							if (E3valueVisualIDRegistry
									.getVisualID(outgoingLink) == ValueExchangeEditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(
