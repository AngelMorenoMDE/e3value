 ...
 * @generated
 */
public class CompositeActorItemSemanticEditPolicy extends
		E3valueBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public CompositeActorItemSemanticEditPolicy() {
		super(E3valueElementTypes.CompositeActor_3016);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (E3valueElementTypes.ValueInterface_3001 == req.getElementType()) {
			return getGEFWrapper(new ValueInterfaceCreateCommand(req));
		}
					...
					case StartStimulusEditPart.VISUAL_ID:
						for (Iterator<?> it = cnode.getTargetEdges().iterator(); it
							...
							if (E3valueVisualIDRegistry
									.getVisualID(incomingLink) == ConnectionElementEditPart.VISUAL_ID) {
						...
						for (Iterator<?> it = cnode.getSourceEdges().iterator(); it
							...
							if (E3valueVisualIDRegistry
									.getVisualID(outgoingLink) == ConnectionElementEditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(
