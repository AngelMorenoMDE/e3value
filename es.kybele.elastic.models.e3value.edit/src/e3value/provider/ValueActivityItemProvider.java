...
public class ValueActivityItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addHasValueInterfacesPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Has Value Interfaces feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addHasValueInterfacesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ValueActivity_hasValueInterfaces_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ValueActivity_hasValueInterfaces_feature", "_UI_ValueActivity_type"),
				 E3valuePackage.Literals.VALUE_ACTIVITY__HAS_VALUE_INTERFACES,
				 true,
				 false,
				 true,
				 null,
