...
public class JoinElementItemProvider extends LogicalElementItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(E3valuePackage.Literals.JOIN_ELEMENT__HAS_INPUT_PORTS);
	...
	public String getText(Object object) {
		return getString("_UI_JoinElement_type");
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(E3valuePackage.Literals.JOIN_ELEMENT__HAS_INPUT_PORTS,
